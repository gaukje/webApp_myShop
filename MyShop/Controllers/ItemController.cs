    ...
    public class ItemController : Controller
    {
        ...
        public List<Item> GetItems()
        {
            ...
            var item1 = new Item
            {
                ...
                Name = "Pizza",
                Price = 150,
                Description = "Delicious Italian dish with a thin crust topped with tomato sauce, cheese" +
            ...
            var item2 = new Item
            {
                ...
                Price = 20,
                Description = "Crispy and succulent chicken leg that is deep-fried to perfection, often served as a popular side dish or snack.",
            ...
            var item7 = new Item
            {
                ...
                Name = "Cider",
                Price = 50,
                Description = "Refreshing alcoholic beverage made from fermented apple juice, available in various flavours.",
